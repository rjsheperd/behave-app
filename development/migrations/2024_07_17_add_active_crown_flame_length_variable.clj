...
(do
  (require '[behave-cms.server        :as cms]
           ...
           '[cms-import               :refer [add-export-file-to-conn ->class]])
  ...
  (def new-group-variable-tx
    (-> (sm/->group-variable [:bp/uuid (:bp/uuid new-subgroup-tx)]
  ...
  (def link-tx
    (sm/->link crown-final-flame-length [:bp/uuid (:bp/uuid new-group-variable-tx)]))

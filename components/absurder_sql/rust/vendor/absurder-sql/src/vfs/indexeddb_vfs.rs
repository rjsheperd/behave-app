...
macro_rules! vfs_log {
    ($($arg:tt)*) => {
        crate::utils::debug_log_1(&format!($($arg)*).into());
    };
}
        ...
        for block_id in start_block..=end_block {
            ...
            if src_end <= data.len() && block_end <= BLOCK_SIZE {
                ...
                #[cfg(target_arch = "wasm32")]
                {
                    ...
                    crate::utils::debug_log_1(&format!("DEBUG: VFS write block {} offset={} len={} block_start={} block_end={} copy_len={} - existing: {}, new_data: {}", 

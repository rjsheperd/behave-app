...
public:
  UnitResolver() {
    ...
    addUnit(AreaUnits::SquareKilometers, "km2");
    ...
    addUnit(LoadingUnits::KilogramsPerSquareMeter, "kg/m2");
    addUnit(LoadingUnits::PoundsPerSquareFoot, "lbs/ft2");
    addUnit(LoadingUnits::TonnesPerHectare, "tonne/ha");
    addUnit(LoadingUnits::TonsPerAcre, "ton/ac");

    addUnit(PressureUnits::Atmosphere, "atm");
    addUnit(PressureUnits::Bar, "bar");
    addUnit(PressureUnits::GigaPascal, "gPa");
    addUnit(PressureUnits::HectoPascal, "hPa");
    addUnit(PressureUnits::KiloPascal, "kPa");
    addUnit(PressureUnits::MegaPascal, "MPa");
    addUnit(PressureUnits::Pascal, "Pa");
    addUnit(PressureUnits::PoundPerSquareInch, "psi");
    addUnit(PressureUnits::TechnicalAtmosphere, "at");
    ...
    addUnit(TemperatureUnits::Kelvin, "K");

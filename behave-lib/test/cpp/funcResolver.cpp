...
public:
  ...
  // Continous Setter (1-Arity)
  template<typename ObjType>
  void wrapperContinuousSetter_1(ObjType* obj, void (ObjType::*func)(double), double num) {
    // Call the member function of the object with the converted EnumType
    (obj->*func)(num);
  }

  template<typename ObjType>
  std::function<void(void*, double)> convertContinuousSetter_1(void (ObjType::*func)(double)) {
    return [=](void* obj, double num) {
